...
public class compress {
	...
	public compress(String linkOfFile, String linkOfFolder) {
		try {
			...
			// But I have no idea how you need to rearrange the link where it saves the new
			// file...
			// Good luck ;)
			//
			/*
			 * Nicolas 09.12.2018: I think it could go in that direction... Hoping that
			 * "image" represents the current image name it should save it to the newly
			 * created folder inside the images folder.
			 */
